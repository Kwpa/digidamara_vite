        ...
        <nav class="level is-mobile icon-area">
          <div class="level-item has-text-centered">
            <div id="chat-footer-button" class="badger has-background-dark" style="padding: 0px;">
              <img class="hdrftr-icon ftr-icon" src="/assets/ui_icons/icon_UI_chat_alt_transparent_36px.png"></img>
          ...
          <div class="level-item has-text-centered">
            <div id="vote-footer-button" class="badger has-background-dark" style="padding: 0px;">
              <img class="hdrftr-icon ftr-icon" src="/assets/ui_icons/icon_UI_ballotbox_alt_transparent_36px.png"></img>
          ...
          <div class="level-item has-text-centered">
            <div id="video-footer-button" class="badger has-background-dark" style="padding: 0px;">
              <img class="hdrftr-icon ftr-icon" src="/assets/ui_icons/icon_UI_camera_transparent_36px.png"></img>
          ...
          <div class="level-item has-text-centered">
            <div id="settings-footer-button" class="has-background-dark" style="padding: 0px;">
              <img class="hdrftr-icon ftr-icon" src="/assets/ui_icons/icon_UI_settings_transparent_36px.png"></img>
